...
// Task to bundle all the .jsx files into one and allow them to be read by the Node backend (Runs browserify to combine jsx files and babelify to allow es6 to work with node backend).
